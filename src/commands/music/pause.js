...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (player.isPaused) {
      return replyError(interaction, 'Already paused', 'Playback is already paused. Use `/resume`.');
    }
    player.pause();
    return interaction.reply({ embeds: [embeds.success('Paused', 'Playback paused. Use `/resume` to continue.')] });
  },
};
